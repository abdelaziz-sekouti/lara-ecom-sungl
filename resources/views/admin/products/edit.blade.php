            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="slug" name="slug" value="{{ old('slug', $product->slug) }}" 
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" 
                           required>
                    <p class="mt-1 text-sm text-gray-500">URL-friendly version of name (e.g., "aviator-sunglasses")</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="frame_type" name="frame_type" value="{{ old('frame_type', $product->frame_type) }}" 
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" 
                           required>
                </div>
                ...
                <div class="lg:col-span-2">
                    ...
                    @if($product->image)
                        <div class="flex items-center space-x-4 mb-4">
                            ...
                            <span class="text-sm text-gray-600">{{ $product->image }}</span>
                        </div>
                    @else
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700">Replace Product Image</label>
